export default function DataAnalysisPage() {
    return (
      <div className="docs-content">
        ...
        <p>These libraries can capture specfic metrics needed for your eval or to give your team insights into your data.</p>
        <p>Also they can display your data in a clean visual way to help you understand your data better.</p>

        <h2>DataFrame Libraries</h2>
        <ul>
            <li>Pandas</li>
            <li>Polars</li>
        </ul>
